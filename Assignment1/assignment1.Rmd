...
$\hat{\theta} = 8.55$, and the confidence interval (CI) is: $(7.81, 9.29)$. We can increase the CI by increasing the sample size, the bigger the sample size the lower CI will be, as there is more information available.
